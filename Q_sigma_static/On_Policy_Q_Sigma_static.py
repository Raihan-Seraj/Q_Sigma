...
def take_average_results(experiment,num_experiments,num_episodes,env,theta):
	...
	for i in range(num_experiments):
		...
		np.save('/home/raihan/Desktop/Final_Project_Codes/mountain_car_results/Q_sigma_static/'  + 'Qsigma_onpolicy_reward' + '.npy',average_reward)
		np.save('/home/raihan/Desktop/Final_Project_Codes/mountain_car_results/Q_sigma_static/'  + 'Qsigma_onpolicy_error' + '.npy',average_error)
