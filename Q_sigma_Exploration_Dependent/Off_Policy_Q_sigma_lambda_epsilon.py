...
def Q_Sigma_Lambda_Off_Policy_Epsilon_Dependent(env, theta, num_episodes, discount_factor=1.0, epsilon=0.1, epsilon_decay=0.999, alpha=0.1, lambda_param=0.8):
	...
	for i_episode in range(num_episodes):
		...
		print ("Episode Number, Q (sigma, lambda) Off Policy, Epsilon_Sigma:", i_episode)
		...
		off_policy = epsilon_greedy_policy(theta, epsilon, env.action_space.n)
		state = env.reset()
...
def take_average_results(experiment,num_experiments,num_episodes,env,theta):
	...
	for i in range(num_experiments):
		...
		np.save('/home/raihan/Desktop/Final_Project_Codes/cliff_walking_results/Exploration_Dependent/'  + 'Q_Sigma_Lambda_Off_Policy_Epsilon_Dependent_Cum_Rwd' + '.npy', average_reward)
		np.save('/home/raihan/Desktop/Final_Project_Codes/cliff_walking_results/Exploration_Dependent/'  + 'Q_Sigma_Lambda_Off_Policy_Epsilon_Dependent_Cum_Err' + '.npy', average_error)
...
def main():
	...
	print ("Q(sigma, lambda) Off Policy Dependent on Epsilon Greedy")
	...
	avg_cum_reward, avg_cum_error = take_average_results(Q_Sigma_Lambda_Off_Policy_Epsilon_Dependent, num_experiments, num_episodes, env, theta)
