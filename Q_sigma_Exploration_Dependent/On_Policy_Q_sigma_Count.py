...
def take_average_results(experiment,num_experiments,num_episodes,env,theta):
	...
	for i in range(num_experiments):
		...
		np.save('/home/raihan/Desktop/Final_Project_Codes/cliff_walking_results/Exploration_Dependent/'  + 'Qsigma_onpolicy_count_reward' + '.npy',average_reward)
		np.save('/home/raihan/Desktop/Final_Project_Codes/cliff_walking_results/Exploration_Dependent/'  + 'Qsigma_onpolicy_count_error' + '.npy',average_error)
