...
def q_sigma_lambda_off_policy_countbased_sigma(env, theta, num_episodes, discount_factor=1.0, epsilon=0.1, epsilon_decay=1.0, alpha=0.1, lambda_param=0.8):
...
def take_average_results(experiment,num_experiments,num_episodes,env,theta):
	...
	for i in range(num_experiments):
		...
		np.save('/home/raihan/Desktop/Final_Project_Codes/new_windy_results/Exploration_Dependent/'  + 'Qsigmalambda_offpolicy_count_based_reward' + '.npy',average_reward)
		np.save('/home/raihan/Desktop/Final_Project_Codes/new_windy_results/Exploration_Dependent/'  + 'Qsigmalambda_offpolicy_count_based_error' + '.npy',average_error)
