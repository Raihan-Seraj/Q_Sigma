...
def q_sigma_lambda_off_policy_decaying_sigma(env, theta, num_episodes, discount_factor=1.0, epsilon=0.1, epsilon_decay=1.0, alpha=0.1, lambda_param=0.8):
	...
	for i_episode in range(num_episodes):
		...
		print ("Episode Number, Q (sigma, lambda) Off Policy, Decaying Sigma:", i_episode)
...
def take_average_results(experiment,num_experiments,num_episodes,env,theta):
	...
	for i in range(num_experiments):
		...
		np.save('/home/raihan/Desktop/Final_Project_Codes/cliff_walking_results/Q_sigma_lambda/'  + 'Qsigmalambda_offpolicy_static_reward' + '.npy',average_reward)
		np.save('/home/raihan/Desktop/Final_Project_Codes/cliff_walking_results/Q_sigma_lambda/'  + 'Qsigmalambda_offpolicy_static__error' + '.npy',average_error)
