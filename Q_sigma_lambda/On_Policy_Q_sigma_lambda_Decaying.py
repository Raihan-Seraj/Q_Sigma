...
def q_sigma_lambda_on_policy_countbased_sigma(env, theta, num_episodes, discount_factor=1.0, epsilon=0.1, epsilon_decay=0.99, alpha=0.1, lambda_param=0.8):
...
def take_average_results(experiment,num_experiments,num_episodes,env,theta):
	...
	for i in range(num_experiments):
		stats=experiment(env,theta,num_episodes)
		...
		np.save('/home/raihan/Desktop/Final_Project_Codes/mountain_car_results/Q_sigma_lambda/'  + 'Qsigmalambda_onpolicy_reward' + '.npy',average_reward)
		#np.save('/home/raihan/Desktop/Final_Project_Codes/new_windy_results/Q_sigma_lambda/'  + 'Qsigmalambda_onpolicy_error' + '.npy',average_error)
...
def main():
	...
	avg_cum_reward=take_average_results(q_sigma_lambda_on_policy_countbased_sigma,num_experiments,num_episodes,env,theta)
