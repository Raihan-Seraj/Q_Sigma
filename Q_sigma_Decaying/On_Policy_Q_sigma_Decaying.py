...
def take_average_results(experiment,num_experiments,num_episodes,env,theta):
	...
	for i in range(num_experiments):
		...
		np.save('/home/raihan/Desktop/Final_Project_Codes/cliff_walking_results/Sigma_Decaying/'  + 'Qsigma_onpolicy_decaying_reward' + '.npy',average_reward)
		np.save('/home/raihan/Desktop/Final_Project_Codes/cliff_walking_results/Sigma_Decaying/'  + 'Qsigma_onpolicy_decaying_error' + '.npy',average_error)
