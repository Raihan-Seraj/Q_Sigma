...
def Q_Sigma_Off_Policy_Decaying_Sigma(env, theta, num_episodes, discount_factor=1.0, epsilon=0.1, epsilon_decay=0.999):
	...
	for i_episode in range(num_episodes):
		...
		print("The polic function is ",policy)
		...
		for t in itertools.count():
			...
			print("The size of the next action probs is ", np.shape(next_action_probs))
			print(x)
...
def take_average_results(experiment,num_experiments,num_episodes,env,theta):
	...
	for i in range(num_experiments):
		...
		np.save('/home/raihan/Desktop/Final_Project_Codes/cliff_walking_results/Sigma_Decaying/'  + 'Q_sigma_Off_Policy_Decaying_Cum_Rwd' + '.npy', average_reward)
		np.save('/home/raihan/Desktop/Final_Project_Codes/cliff_walking_results/Sigma_Decaying/'  + 'Q_sigma_Off_Policy_Decaying_Cum_Err' + '.npy', average_error)
